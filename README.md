...
# Hello, to use my app just do 2 steps:

# 1. npm install
# 2. npm start

# P.S. I understand that the functionality does not quite correspond to the documentation, but I figured out what to do as I did, will be more user friendly
